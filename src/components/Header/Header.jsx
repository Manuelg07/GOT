    ...
    return(
        <header className='header'>
            ...
            <div className='header__language'>
                ...
                <img className='header__language--img' onClick={() => changeLanguaje("es")} src="/banderadeespaña.png" alt="españa"></img>
                <img className='header__language--img' onClick={() => changeLanguaje("en")} src="/banderaestadosunidos.png" alt="gran-bretaña"></img>
            </div>
        </header>
    )
}